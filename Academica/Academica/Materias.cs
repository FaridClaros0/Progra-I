...
namespace Academica
{
    public partial class Materias : Form
    {
        ...
        private void actualizarDs()
        {
            ...
            grdDatosMateria.DataSource = miTabla;
        ...
        {
            if (btnNuevaMateria.Text == "Nuevo")
            {
                btnNuevaMateria.Text = "Guardar";
        ...
        private void seleccionarMateria()
        {
            try
            {
                posicion = miTabla.Rows.IndexOf(miTabla.Rows.Find(grdDatosMateria.CurrentRow.Cells["idMateria"].Value.ToString()));
                mostrarDatosMaterias();
            }
            catch (Exception)
            {
